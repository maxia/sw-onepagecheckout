<div class="panel register--shipping is--hidden">
    <h2 class="panel--title is--underline">{s name='RegisterShippingHeadline' namespace="frontend/register/shipping_fieldset"}{/s}</h2>
    <div class="panel--body register--shipping is--wide">
        {* Salutation *}
        ...
        {block name='frontend_register_shipping_fieldset_input_salutation'}
            <div class="register--salutation field--select">
                <select name="register[shipping][salutation]" id="salutation2" class="normal is--required{if isset($error_flags.salutation)} has--error{/if}">
                    <option value="" disabled="disabled"{if $form_data.salutation eq ""} selected="selected"{/if}>{s name='RegisterShippingPlaceholderSalutation' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</option>
        ...
        {block name="frontend_register_shipping_fieldset_input_company"}
            <div class="register--companyname">
                <input autocomplete="section-shipping shipping organization"
                       ...
                       type="text"
                       placeholder="{s name='RegisterShippingPlaceholderCompany' namespace="frontend/register/shipping_fieldset"}{/s}"
        ...
        {block name='frontend_register_shipping_fieldset_input_department'}
            <div class="register--department">
                <input autocomplete="section-shipping shipping organization-title"
                       ...
                       type="text"
                       placeholder="{s name='RegisterShippingPlaceholderDepartment' namespace="frontend/register/shipping_fieldset"}{/s}"
        ...
        {block name='frontend_register_shipping_fieldset_input_street'}
            <div class="register--street">
                <input autocomplete="section-shipping shipping street-address"
                       ...
                       required="required"
                       aria-required="true"
                       placeholder="{s name='RegisterShippingPlaceholderStreet' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}"
                       id="street2"
            ...
            <div class="register--zip-city">
                {if {config name=showZipBeforeCity}}
                    <input autocomplete="section-shipping shipping postal-code"
                           ...
                           required="required"
                           aria-required="true"
                           placeholder="{s name='RegisterShippingPlaceholderZipcode' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}"
                           id="zipcode2"
                    ...
                    <input autocomplete="section-shipping shipping address-level2"
                           ...
                           required="required"
                           aria-required="true"
                           placeholder="{s name='RegisterShippingPlaceholderCity' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}"
                           id="city2"
            ...
            <div class="register--shipping-country field--select">
                <select name="register[shipping][country]"
                    ...
                    <option value=""
                            disabled="disabled"
                            selected="selected">
                        {s name='RegisterShippingPlaceholderCountry' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}
                    </option>
                    ...
                    {if $country.states}
                        <div data-country-id="{$country.id}" data-address-type="shipping" class="register--state-selection field--select{if $country.id != $form_data.country} is--hidden{/if}">
                            <select name="register[shipping][country_shipping_state_{$country.id}]"{if $country.force_state_in_registration} required="required" aria-required="true"{/if}{if $country.id != $form_data.country} disabled="disabled"{/if} class="select--state {if $country.force_state_in_registration}is--required{/if}{if isset($error_flags.stateID)} has--error{/if}">
                                <option value="" selected="selected"{if $country.force_state_in_registration} disabled="disabled"{/if}>{s name='RegisterShippingLabelState' namespace="frontend/register/shipping_fieldset"}{/s}{if $country.force_state_in_registration}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</option>
