<div class="panel register--company is--hidden">
    <h2 class="panel--title is--underline">{s name='RegisterHeaderCompany' namespace="frontend/register/billing_fieldset"}{/s}</h2>
...
<div class="panel register--address">
    <h2 class="panel--title is--underline">{s name='RegisterBillingHeadline' namespace="frontend/register/billing_fieldset"}{/s}</h2>
    <div class="panel--body is--wide">
            ...
            {if {config name=showAdditionAddressLine1}}
                <div class="register--additional-line1">
                    <input autocomplete="section-billing billing address-line2"
                           ...
                           placeholder="{s name='RegisterLabelAdditionalAddressLine1' namespace="frontend/register/billing_fieldset"}{/s}{if {config name=requireAdditionAddressLine1}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}"
            ...
            {if {config name=showAdditionAddressLine2}}
                <div class="register--additional-field2">
                    <input autocomplete="section-billing billing address-line3"
                           ...
                           placeholder="{s name='RegisterLabelAdditionalAddressLine2' namespace="frontend/register/billing_fieldset"}{/s}{if {config name=requireAdditionAddressLine2}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}"
        ...
        {block name='frontend_register_billing_fieldset_different_shipping'}
            {if !$update}
                <div class="register--alt-shipping">
                    ...
                    <label for="register_billing_shippingAddress">{s name='RegisterBillingLabelShipping' namespace="frontend/register/billing_fieldset"}{/s}</label>
                </div>
            {/if}
        {/block}
    </div>
