                    ...
                    {if {config name=showCompanySelectField}}
                        <select id="register_personal_customer_type"
                            ...
                            <option value="" disabled="disabled" {if $form_data.customer_type eq ""} selected="selected"{/if}>
                                {s name='RegisterPersonalLabelType' namespace="frontend/register/personal_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}
                            </option>

                            <option value="private" {if $form_data.customer_type eq "private" or (!$form_data.company and $sUserLoggedIn)} selected="selected"{/if}>
                                {s name='RegisterPersonalLabelPrivate' namespace="frontend/register/personal_fieldset"}{/s}
                            </option>
                            ...
                            <option value="business"{if $form_data.customer_type eq "business" or $form_data.company or $form_data.sValidation} selected="selected"{/if}>
                                {s name='RegisterPersonalLabelBusiness' namespace="frontend/register/personal_fieldset"}{/s}
                            </option>
                        </select>
                    {else}
                        ...
                        <div class="is--hidden">
                            <select id="register_personal_customer_type" name="register[personal][customer_type]">
                                <option value="private" selected="selected">{s name='RegisterPersonalLabelPrivate' namespace="frontend/register/personal_fieldset"}{/s}</option>
                            </select>
                        </div>
                    {/if}
                </div>
            ...
            {block name='frontend_register_personal_fieldset_skip_login'}
                {if ($showNoAccount || $form_data.accountmode) && !$sEsd && !$form_data.sValidation && !{config name=NoAccountDisable}}
                    <div class="register--check">
                        ...
                        <label for="register_personal_skipLogin" class="chklabel is--bold">{s name='RegisterLabelNoAccount' namespace="frontend/register/personal_fieldset"}{/s}</label>
                    </div>
                {else}
                    <input type="hidden"
                           value="0"
                ...
                {if {config name=doubleEmailValidation}}
                    <div class="register--emailconfirm">
                        <input autocomplete="section-personal email"
                               ...
                               required="required"
                               aria-required="true"
                               placeholder="{s name='RegisterPlaceholderMailConfirmation' namespace="frontend/register/personal_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}"
            ...
            <div class="register--account-information">
                ...
                {block name='frontend_register_personal_fieldset_password_description'}
                    <div class="register--password-description">
                        {s name='RegisterInfoPassword' namespace="frontend/register/personal_fieldset"}{/s} {config name=MinPassword} {s name='RegisterInfoPasswordCharacters' namespace="frontend/register/personal_fieldset"}{/s}<br />{s name='RegisterInfoPassword2' namespace="frontend/register/personal_fieldset"}{/s}
                    </div>
                {/block}
            </div>
        {/if}
        ...
        {if {config name=showBirthdayField} && !$update}
            {block name='frontend_register_personal_fieldset_birthday'}
                <div class="register--birthdate">
                    <label for="register_personal_birthdate" class="birthday--label">{s name='RegisterPlaceholderBirthday' namespace="frontend/register/personal_fieldset"}{/s}{if {config name=requireBirthdayField}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
